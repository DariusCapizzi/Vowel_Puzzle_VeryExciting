...
public class VowelReplaceTest {
  ...
  @Test
  public void VowelReplace_ReturnStringWithReplaceAllMethod_String(){
    String expected = "s-p-rc-l-FR-G-L-st-c-xp--l-d-c---s";
    assertEquals(expected, VowelReplace.vowelsToDashWithReplaceAll("supercaliFRAGIListicexpialidocious"));
  }
}
